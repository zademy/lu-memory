 ...
 * 
 * <p>
 * This record encapsulates all metadata and content for observations that
 * agents
 * create to maintain long-term context. Observations can represent
 * architectural decisions,
 * bug fixes, patterns, notes, or any other significant information that needs
 * to be
 * preserved across sessions for future reference.
 * </p>
 * 
 * <p>
 ...
 * @param type            the observation type (e.g., "DECISION", "BUGFIX",
 *                        "PATTERN", "NOTE", "ARCHITECTURE", "SUMMARY",
 *                        "DOCUMENTATION")
 ...
 * @param content         the detailed content following the What/Why/Where
 *                        format
 * @param tagsText        comma-separated tags for search and categorization
 * @param source          the source of the observation (e.g., "agent-decision",
 *                        "user-prompt")
 ...
 * @param deleted         soft-delete flag (true if observation is marked as
 *                        deleted)
 ...
 * @param importanceLevel the level of importance (HIGH, MEDIUM, LOW)
 * 
