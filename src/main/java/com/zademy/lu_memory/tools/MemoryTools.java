...
import org.springframework.ai.mcp.annotation.ToolParam;
...
public class MemoryTools {
    ...
    @Tool(description = "Save a structured observation")
    public Map<String, Object> memSave(
            @ToolParam(description = "Observation type: DECISION, BUGFIX, PATTERN, NOTE") String type,
            ...
            @ToolParam(description = "Session ID (UUID)") String sessionId,
        ...
        ObservationEntity observation = memoryService.saveObservation(
                ...
                content,
                tags,
                sessionId == null || sessionId.isBlank() ? null : UUID.fromString(sessionId),
                source
        );
    ...
    @Tool(description = "Delete an observation; soft-delete by default")
    ...
    @Tool(description = "Suggest a stable topic key")
    ...
    @Tool(description = "Chronological context around an observation")
    ...
    @Tool(description = "Get full content of specific memory")
